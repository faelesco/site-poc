...
var StartScreenWidget = function () {
    ...
    this._appKey = "c2FmcmFkZXZzYWZyYWVtcHJlc2FzOjVrcjBPVGhOeFpUVkt4QXllYklO";
    this._widgetLocation = "https://unpkg.com/blip-chat-widget";
    this._apiUrl = 'https://.../FIAT';
    ...
    this._startScreenHtmlLink = "start-screen.html";
    ...
    this.toggleIframe = function(visible) {
        ...
        if(!visible){
            setTimeout(function(){
                ...
                if(blipChatFrame.classList && !blipChatFrame.classList.contains('opened')){
                    setTimeout(function(){
        ...
        fetch(self._startScreenHtmlLink)
            ...
            .then(function (c) {
                ...
                document.getElementById('blip-chat-open-iframe').addEventListener('click', function(event){
                    var blipChatFrame = document.getElementById('blip-chat-open-iframe');
                    self.toggleIframe((blipChatFrame && blipChatFrame.classList && !blipChatFrame.classList.contains('opened')));
                });
...
var StartScreenWidgetObj = new StartScreenWidget();

StartScreenWidgetObj.load();